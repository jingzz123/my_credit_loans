	...
	$("#roleInfoForm").validate({
		...
		submitHandler:function(){
			...
			if(checkedNodes.length>0 && menuname!=""){
				...
				jQuery.ajax({
					type: "post",
				    url: "${pageContext.request.contextPath}/platform/role/doAdd",
			    	...
			    	<div class="col-md-12">
				    	<form id="roleInfoForm" class="form-horizontal" >
							  <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="text" id="name" name="name" class="form-control" placeholder="输入角色名称" >
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="text" name="description" id="description" class="form-control"   placeholder="输入角色描述">
							    </div>
