	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					企业账户管理<small> <i class="icon-double-angle-right"></i>
						设置企业账户
					</small>
				</h1>
			</div><!-- /.page-header -->
				...
				<div class="col-xs-12">
					<div class="table-responsive table-responsive-a">
						...
						<div id="sample-table-2_wrapper" class="dataTables_wrapper">
							<div class="row ">
								<form  class="form-inline" id="queryForm" action="${pageContext.request.contextPath}/enterprise/info/enterpriseInfoList" method="post">
									...
									<div class="form-group">
										<input type="text" name="name" value="${name}"  placeholder="..请输入企业名称">
									</div>
									<div class="form-group">
									...
									<tr>	
							          ...
							          <td>
							          	<div class="action-buttons">
											<a class="green" href="#" onclick="updateEnterpriseType('${enterpriseInfo.id}')" title="修改"> <i class="icon-pencil bigger-130" ><font style="color: black;font-size: 12px;"></font></i></a>
											<a class="red" href="#" onclick="deleteEnterpriseInfo('${enterpriseInfo.id}')" title="禁用"> <i class="icon-remove-circle bigger-130"><font style="color: black;font-size: 12px;"></font></i></a>
										</div>
									  </td>
							        </tr>
						        </c:forEach>
...
function addEnterpriseInfo(){
	window.location.href = "${pageContext.request.contextPath}/enterprise/info/enterpriseInfoInput";
}
...
function deleteEnterpriseInfo(id){
	if(window.confirm("你确定要禁用该企业")){
		$.ajax({
			type:"POST",
			url:"${pageContext.request.contextPath}/enterprise/info/deleteEnterpriseInfo",
			data:{"strId":id},
...
function updateEnterpriseType(id){
	window.location.href = "${pageContext.request.contextPath}/enterprise/info/updateEnterpriseInfo?id="+id;
}
