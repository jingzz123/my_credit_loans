...
$().ready(function() {
	...
	$("#schemaInfoForm").validate({
		...
		submitHandler:function(){
			schemaInfoForm = $('#schemaInfoForm').serializeObject()
			...
			jQuery.ajax({
				type: "post",
			    url: "${pageContext.request.contextPath}/regulation/metadata/schema/doAdd",
			    contentType: "application/json",
			    data: JSON.stringify(schemaInfoForm),
			    success: function (schemaId) {
			    	if(schemaId>0){
				        alert("添加schema成功！");
			    	}else{
			    		alert("添加schema失败！");
			    ...
			    error: function () {
			        alert("save regulation schema error");
			    }	
			});
		}
	});
			    	...
			    	<div class="col-md-12">
				    	...
				    	<fieldset>
							  <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="text" id="name" name="name" class="form-control" placeholder="输入schema名称" >
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="text" id="delimiter" name="delimiter" class="form-control" placeholder="输入分隔符">
							    </div>
							    ...
							    <div class="col-sm-3">
							      <input id="isNested_yes" name="isNested" type="radio" checked="checked" value="Y"/>是 
							      <input id="isNested_not" name="isNested" type="radio" value="N"/>否
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="text" id="idLength" name="idLength" class="form-control" placeholder="输入schemaId长度">
							    </div>
							  ...
							  <div class="form-group" id="mainSchema" style="display:none">
							    ...
							    <div id="main_showspace" class="col-sm-3">
							    	<c:forEach items="${metadataSchemaDTOList}" var="mainSchema">
							    		<input type="checkbox"  value="${mainSchema.id}" name="mainSchemaIdList"/>${mainSchema.name}
							    	</c:forEach>
							    </div>
