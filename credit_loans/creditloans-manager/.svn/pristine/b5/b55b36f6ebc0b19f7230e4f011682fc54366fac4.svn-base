	...
	$("#userInfoForm").validate({
		...
		rules: {
			...
			email:{
			    ...
			    email: true,
			    remote:{
					url:"${pageContext.request.contextPath}/platform/user/checkEmail",
					type: "post",
				    dataType: "json",
				    data: {
				    	email: function() {
		...
		submitHandler:function(){
			...
			jQuery.ajax({
				type: "post",
			    url: "${pageContext.request.contextPath}/platform/user/doAdd",
			    contentType: "application/json",
			    data: JSON.stringify(userInfoJson),
			    success: function (platformUserId) {
			    	if(platformUserId>0){
				        alert("添加用户成功！");
			    	}else{
			    		alert("添加用户失败！");
			    ...
			    error: function () {
			        alert("save platform user error");
			    }	
			});
		}
	});
			    	...
			    	<div class="col-md-12">
				    	<form id="userInfoForm" class="form-horizontal" >
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="text" id="phone" name="phone" class="form-control" placeholder="输入手机号码">
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-3">
							      <input type="text" id="qq" name="qq" class="form-control" placeholder="输入QQ号码">
							    </div>
							  ...
							  <div class="form-group">
							    ...
							    <div id="role_showspace" class="col-sm-3">
							    	<c:forEach items="${platformRoleDtoList}" var="role">
