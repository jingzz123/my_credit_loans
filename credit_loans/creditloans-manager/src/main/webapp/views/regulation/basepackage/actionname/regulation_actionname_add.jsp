...
$().ready(function() {
	$("#actionNameInfoForm").validate({
		...
		submitHandler:function(){
			...
			jQuery.ajax({
				type: "post",
			    url: "${pageContext.request.contextPath}/regulation/basepackage/actionname/doAdd",
			    contentType: "application/json",
			    data: JSON.stringify(actionNameInfoForm),
			    success: function (actionNameId) {
			    	if(actionNameId>0){
				        alert("添加actionname成功！");
			    	}else{
			    		alert("添加actionname失败！");
			    		
			    	}
			    	window.location.href = "${pageContext.request.contextPath}/regulation/basepackage/actionname/showList";
			    },
			    error: function () {
			        alert("save regulation actionname error");
			    }	
			});
		}
	});
			    	...
			    	<div class="col-md-12">
				    	...
				    	<fieldset>
							  <div class="form-group">
							   ...
							   <label for="description" class="col-sm-1 control-label">动作名称描述</label>
							    <div class="col-sm-3">
