			    ...
			    <div class="col-md-12">
				    <form id="enterpriseInfo" class="form-horizontal" >
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-4">
						    	<input type="text" id="userEmail" name="userEmail" class="form-control" placeholder="输入企业(email)帐号" value="${enterprise.userEmail}" readonly="readonly">
						    </div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
							   <input type="password" id="userPassword" name="userPassword" class="form-control" value="${enterprise.userPassword }" placeholder="输入企业密码" readonly="readonly">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
							<c:if test="${enterprise.isinvalid == 0}">
							...
							<c:if test="${enterprise.isinvalid == 1}">
						...
						<input type="hidden" id="roleId" name="roleId" value="${enterprise.roleId}"/>
						<input type="hidden" id="createType" name="createType" value="${enterprise.createType}"/>
		...
		$("#enterpriseInfo").validate({
			...
			submitHandler:function(){
				...
				if(checkedNodes.length>0 && menuname!=""){
					...
					jQuery.ajax({
						type: "post",
						url:"${pageContext.request.contextPath}/enterprise/info/updateEnterprise",
	...
	function getAllMenuTree(){
		...
		jQuery.ajax({
	        ...
	        success: function (data) {
	        	...
	        	var menuIdList = eval("${enterprise.menuIdList}");
	        	var menuList = "";
