			...
			<div class="col-xs-12">
				<div class="col-md-12">
					<form id="dbxxInfoForm" class="form-horizontal">
						...
						<input type="hidden" id="oldDbrzjhm" name="oldDbrzjhm">
...
$().ready(function() {
	...
	$("#dbxxInfoForm").validate({
		...
		submitHandler:function(){
			...
			jQuery.ajax({
				type: "post",
			    url: "${pageContext.request.contextPath}/p2p/dbxx/doAdd",
			    contentType: "application/json",
			    data: JSON.stringify(dbxxInfoForm),
			    success: function (p2pDbxxId) {
			    	if(p2pDbxxId>0){
				        alert("添加成功！");
			    	}else{
			    		alert("添加失败！");
