...
// 判断整数value是否等于0 
    ...
    $.validator.addMethod("isEnAndNum", function(value, element) {
    	return this.optional(element) || /^[A-Za-z0-9]+$/.test(value);
    }, "只能包含英文数字"); 
    
    $.validator.addMethod("isCapitalEnAndNum", function(value, element) {
    ...
    $.validator.addMethod("realLength", function(value, element, param) {
    	var length = getRealLength(value);
