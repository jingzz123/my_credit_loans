...
public class EnterpriseRoleController {
	...
	@RequestMapping(value = "/showList", method = { RequestMethod.GET,
			RequestMethod.POST })
	public String enterpriseRoleList(Model model, HttpServletRequest request, @RequestParam(value = "currentPage", required = false) String _currentPage, EnterpriseRoleDTO enterpriseRoleDto) {
		...
		enterpriseRoleDto.setEnterpriseId(enterpriseLoginUserDto.getEnterpriseId());
		enterpriseRoleDto.setType(1);
		int currentPage = 1;
	...
	@RequestMapping(value = "/add", method = { RequestMethod.GET,
			RequestMethod.POST })
	public String showAddEnterpriseRole(){
	...
	public @ResponseBody int addEnterpriseRole(HttpServletRequest request, @RequestBody EnterpriseRoleDTO enterpriseRoleDto) {
		String token = CookieUtil.getToken(request, "enterprise-token");
		EnterpriseUserDTO enterpriseLoginUserDto = enterpriseUserService.getEnterpriseUserDtoFromCache(token);
		enterpriseRoleDto.setEnterpriseId(enterpriseLoginUserDto.getEnterpriseId());
		enterpriseRoleDto.setType(1);
