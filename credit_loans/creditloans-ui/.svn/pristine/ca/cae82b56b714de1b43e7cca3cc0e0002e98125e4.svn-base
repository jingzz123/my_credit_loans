...
$().ready(function() {
	...
	$("#dbjbxxInfoForm").validate({
		...
		submitHandler:function(){
			...
			jQuery.ajax({
				url: "${pageContext.request.contextPath}/db/dbjbxx/doEdit", 
				type: "post",
...
//临时处理，后面不用这种方式
function loadSelect(){	
	var bdbrlx = "${dbjbxxDto.bdbrlx}";
	var bdbrzjlx = "${dbjbxxDto.bdbrzjlx}";
	var dbywzl = "${dbjbxxDto.dbywzl}";
	var dbfs = "${dbjbxxDto.dbfs}";
	var fdbfs = "${dbjbxxDto.fdbfs}";
	var dbhtzt = "${dbjbxxDto.dbhtzt}";
	var jxzcbz = "${dbjbxxDto.jxzcbz}";
	var jflb = "${dbjbxxDto.jflb}";
	var jnfs = "${dbjbxxDto.jnfs}";
	var jnpl = "${dbjbxxDto.jnpl}";
	var bfjnzt = "${dbjbxxDto.bfjnzt}";
	
	
	$("#bdbrlx_select").find("option[value="+bdbrlx+"]").attr("selected",true);
	$("#bdbrzjlx_select").find("option[value="+bdbrzjlx+"]").attr("selected",true);
	$("#dbywzl_select").find("option[value="+dbywzl+"]").attr("selected",true);
	$("#dbfs_select").find("option[value="+dbfs+"]").attr("selected",true);
	$("#fdbfs_select").find("option[value="+fdbfs+"]").attr("selected",true);
	$("#dbhtzt_select").find("option[value="+dbhtzt+"]").attr("selected",true);
	$("#jxzcbz_select").find("option[value="+jxzcbz+"]").attr("selected",true);
	$("#jflb_select").find("option[value="+jflb+"]").attr("selected",true);
	$("#jnfs_select").find("option[value="+jnfs+"]").attr("selected",true);
	$("#jnpl_select").find("option[value="+jnpl+"]").attr("selected",true);
	$("#bfjnzt_select").find("option[value="+bfjnzt+"]").attr("selected",true);
}
</script>
			...
			<div class="col-xs-12">
				<div class="col-md-12">
					<form id="dbjbxxInfoForm" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dbjgdm" name="dbjgdm" class="form-control"
										placeholder="输入担保机构代码" value="${dbjbxxDto.dbjgdm}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="dbywbh" name="dbywbh" class="form-control"
										placeholder="输入担保业务编号" value="${dbjbxxDto.dbywbh}" >
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dbhthm" name="dbhthm" class="form-control"
										placeholder="输入担保合同号码" value="${dbjbxxDto.dbhthm}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="bdbrmc" name="bdbrmc" class="form-control"
										placeholder="被担保人名称" value="${dbjbxxDto.bdbrmc}" >
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="bdbrzjhm" name="bdbrzjhm" class="form-control"
										placeholder="被担保人证件号码" value="${dbjbxxDto.bdbrzjhm}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="sjbgrq" name="sjbgrq" type="text"
											placeholder="数据报告日期" readonly="readonly" value="${dbjbxxDto.sjbgrq}"> <span
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dbje" name="dbje" class="form-control"
										placeholder="输入担保金额" value="${dbjbxxDto.dbje}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="dbqsrq" name="dbqsrq" type="text"
											placeholder="担保起始日期" readonly="readonly" value="${dbjbxxDto.dbqsrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="dbdqrq" name="dbdqrq" type="text"
											placeholder="担保到期日期" readonly="readonly" value="${dbjbxxDto.dbdqrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
								...
								<div class="col-sm-3">
									<input type="text" id="ccbzjbl" name="ccbzjbl" class="form-control"
										placeholder="存出保证金比例" value="${dbjbxxDto.ccbzjbl}">
								</div>
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="ydzdbbcbl" name="ydzdbbcbl" class="form-control"
										placeholder="约定再担保补偿比例" value="${dbjbxxDto.ydzdbbcbl}">
								</div>
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="fl" name="fl" class="form-control"
										placeholder="费率" value="${dbjbxxDto.fl}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="nhfl" name="nhfl" class="form-control"
										placeholder="年化费率" value="${dbjbxxDto.nhfl}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="dbzrjcrq" name="dbzrjcrq" type="text"
											placeholder="担保责任解除日期" readonly="readonly" value="${dbjbxxDto.dbzrjcrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="zbye" name="zbye" class="form-control"
										placeholder="输入在保余额" value="${dbjbxxDto.zbye}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="yebhrq" name="yebhrq" type="text"
											placeholder="余额变化日期" readonly="readonly" value="${dbjbxxDto.yebhrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="jzrq" name="jzrq" type="text"
											placeholder="记账日期" readonly="readonly" value="${dbjbxxDto.jzrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="zjycdcrq" name="zjycdcrq" type="text"
											placeholder="最近一次代偿日期" readonly="readonly" value="${dbjbxxDto.zjycdcrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
								...
								<div class="col-sm-3">
									<input type="text" id="ljdcje" name="ljdcje" class="form-control"
										placeholder="输入累计代偿金额" value="${dbjbxxDto.ljdcje}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="bjgcddcje" name="bjgcddcje" class="form-control"
										placeholder="输入本机构承担代偿金额" value="${dbjbxxDto.bjgcddcje}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="zjyczcrq" name="zjyczcrq" type="text"
											placeholder="最近一次代偿日期" readonly="readonly" value="${dbjbxxDto.zjyczcrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="ljzcje" name="ljzcje" class="form-control"
										placeholder="输入累计追偿金额" value="${dbjbxxDto.ljzcje}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="ljssje" name="ljssje" class="form-control"
										placeholder="输入累计损失金额" value="${dbjbxxDto.ljssje}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="bfjnjzrq" name="bfjnjzrq" type="text"
											placeholder="保费缴纳记账日期" readonly="readonly" value="${dbjbxxDto.bfjnjzrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="bfjnje" name="bfjnje" class="form-control"
										placeholder="输入保费缴纳金额" value="${dbjbxxDto.bfjnje}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="jfqsrq" name="jfqsrq" type="text"
											placeholder="计费起始日期" readonly="readonly" value="${dbjbxxDto.jfqsrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="jnjsrq" name="jnjsrq" type="text"
											placeholder="缴纳结束日期" readonly="readonly" value="${dbjbxxDto.jnjsrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="bfjnye" name="bfjnye" class="form-control"
										placeholder="输入保费缴纳余额" value="${dbjbxxDto.bfjnye}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="ljqjje" name="ljqjje" class="form-control"
										placeholder="输入累计欠缴金额" value="${dbjbxxDto.ljqjje}">
								</div>
						...
						<input type="hidden" name="orgCode" value="${dbjbxxDto.orgCode}">
						<input type="hidden" name="id" value="${dbjbxxDto.id}">
						<div class="form-group">
