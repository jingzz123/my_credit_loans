					...
					<form id="dksqxxInfoForm" class="form-horizontal">
							...
							<div class="form-group">								
								...
								<div class="col-sm-3">
									<input type="text" id="dksqh" name="dksqh" class="form-control"
										placeholder="输入贷款申请号"  value="${p2pDksqxxDto.dksqh}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="xm" name="xm" class="form-control"
										placeholder="输入姓名" value="${p2pDksqxxDto.xm}">
								</div>
							...
							<div class="form-group">								
								...
								<div class="col-sm-3">
									<input type="text" id="zjhm" name="zjhm" class="form-control"
										placeholder="输入证件号码"  value="${p2pDksqxxDto.zjhm}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dksqje" name="dksqje" class="form-control"
										placeholder="输入贷款申请金额"  value="${p2pDksqxxDto.dksqje}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dksqzq" name="dksqzq" class="form-control"
										placeholder="输入贷款申请周期" value="${p2pDksqxxDto.dksqzq}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="dksqsj" name="dksqsj" type="text"
											placeholder="贷款申请时间" readonly="readonly" value="${p2pDksqxxDto.dksqsj}"> <span
						...
						<fieldset>
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-3">
							      	<c:if test="${p2pDksqxxDto.status == 1}">
								    ...
								    <c:if test="${p2pDksqxxDto.status == 2}">
						...
						<input type="hidden" id="oldDksqh" name="oldDksqh" value="${p2pDksqxxDto.dksqh}">
						<input type="hidden" name="dksqys" value="${p2pDksqxxDto.dksqys}">
						<input type="hidden" id="orgCode" name="orgCode" value="${p2pDksqxxDto.orgCode}">
						<input type="hidden" name="id" value="${p2pDksqxxDto.id}">
						<div class="form-group">
...
$().ready(function() {
	...
	$("#dksqxxInfoForm").validate({
		...
		submitHandler:function(){
			...
			jQuery.ajax({
				type: "post",
			    url: "${pageContext.request.contextPath}/p2p/dksqxx/doEdit",
...
//临时处理，后面不用这种方式
function loadSelect(){
	var zjlx = "${p2pDksqxxDto.zjlx}";
	var dksqlx = "${p2pDksqxxDto.dksqlx}";
	var dksqzt = "${p2pDksqxxDto.dksqzt}";
	var dksqzqdw = "${p2pDksqxxDto.dksqzqdw}";
	
	$("#zjlx_select").find("option[value="+zjlx+"]").attr("selected",true);
	$("#dksqlx_select").find("option[value="+dksqlx+"]").attr("selected",true);
	$("#dksqzt_select").find("option[value="+dksqzt+"]").attr("selected",true);	
	$("#dksqzqdw_select").find("option[value="+dksqzqdw+"]").attr("selected",true);
}
