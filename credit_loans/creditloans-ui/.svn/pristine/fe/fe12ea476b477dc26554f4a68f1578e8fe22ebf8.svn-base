					...
					<form id="dkjbxxInfoForm" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dkhthm" name="dkhthm"
										class="form-control" placeholder="输入贷款合同号码" value="${p2pDkjbxxDto.dkhthm}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="ywh" name="ywh" class="form-control"
										placeholder="输入业务号" value="${p2pDkjbxxDto.ywh}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="khrq" name="khrq" type="text"
											placeholder="开户日期" readonly="readonly" value="${p2pDkjbxxDto.khrq}"> <span
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="dqrq" name="dqrq" type="text"
											placeholder="到期日期" readonly="readonly" value="${p2pDkjbxxDto.dqrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="sxed" name="sxed" class="form-control"
										placeholder="输入授信额度" value="${p2pDkjbxxDto.sxed}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="gxsxed" name="gxsxed" class="form-control"
										placeholder="输入共享授信额度" value="${p2pDkjbxxDto.gxsxed}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="zdfze" name="zdfze" class="form-control"
										placeholder="输入最大负债额" value="${p2pDkjbxxDto.zdfze}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="hkqs" name="hkqs" class="form-control"
										placeholder="输入还款期数" value="${p2pDkjbxxDto.hkqs}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="syhkqs" name="syhkqs" class="form-control"
										placeholder="输入剩余还款月数" value="${p2pDkjbxxDto.syhkqs}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="xdhkqs" name="xdhkqs" class="form-control"
										placeholder="输入协定还款期数" value="${p2pDkjbxxDto.xdhkqs}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="xdqhke" name="xdqhke" class="form-control"
										placeholder="输入协定期还款额" value="${p2pDkjbxxDto.xdqhke}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="jsyhkrq" name="jsyhkrq" type="text"
											placeholder="结算/应还款日期" readonly="readonly" value="${p2pDkjbxxDto.jsyhkrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="zjycsjhkrq" name="zjycsjhkrq" type="text"
											placeholder="最近一次还款日期" readonly="readonly" value="${p2pDkjbxxDto.zjycsjhkrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="byyhkje" name="byyhkje" class="form-control"
										placeholder="输入本月应还款金额" value="${p2pDkjbxxDto.byyhkje}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="bysjhkje" name="bysjhkje" class="form-control"
										placeholder="输入本月实际还款金额" value="${p2pDkjbxxDto.bysjhkje}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="ye" name="ye" class="form-control"
										placeholder="输入余额" value="${p2pDkjbxxDto.ye}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="dqyqqs" name="dqyqqs" class="form-control"
										placeholder="输入当前逾期期数" value="${p2pDkjbxxDto.dqyqqs}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dqyqze" name="dqyqze" class="form-control"
										placeholder="输入当前逾期总额" value="${p2pDkjbxxDto.dqyqze}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="yqwghdkbj1" name="yqwghdkbj1" class="form-control"
										placeholder="输入逾期31-60天未归还贷款本金" value="${p2pDkjbxxDto.yqwghdkbj1}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="yqwghdkbj2" name="yqwghdkbj2" class="form-control"
										placeholder="输入逾期61-90天未归还贷款本金" value="${p2pDkjbxxDto.yqwghdkbj2}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="yqwghdkbj3" name="yqwghdkbj3" class="form-control"
										placeholder="输入逾期91-180天未归还贷款本金" value="${p2pDkjbxxDto.yqwghdkbj3}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="yqwghdkbj4" name="yqwghdkbj4" class="form-control"
										placeholder="输入逾期180天以上未归还贷款本金" value="${p2pDkjbxxDto.yqwghdkbj4}">
								</div>
								...
								<div class="col-sm-3">
									<input type="text" id="ljyqqs" name="ljyqqs" class="form-control"
										placeholder="输入累计逾期期数" value="${p2pDkjbxxDto.ljyqqs}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="zgyqqs" name="zgyqqs" class="form-control"
										placeholder="输入最高逾期期数" value="${p2pDkjbxxDto.zgyqqs}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="xm" name="xm" class="form-control"
										placeholder="输入姓名" value="${p2pDkjbxxDto.xm}">
								</div>
							...
							<div class="form-group">								
								...
								<div class="col-sm-3">
									<input type="text" id="zjhm" name="zjhm" class="form-control"
										placeholder="输入证件号码" value="${p2pDkjbxxDto.zjhm}">
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="dkhtsxrq" name="dkhtsxrq" type="text"
											placeholder="贷款合同生效日期" readonly="readonly" value="${p2pDkjbxxDto.dkhtsxrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
								...
								<div class="col-sm-3">
									<div class="input-group date form_date col-md-3 form-control"
										...
										<input class="form-control" id="dkhtzzrq" name="dkhtzzrq" type="text"
											placeholder="贷款合同终止日期" readonly="readonly" value="${p2pDkjbxxDto.dkhtzzrq}"> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-calendar icon-calendar"></span></span> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove icon-remove"></span></span>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="dkhtje" name="dkhtje" class="form-control"
										placeholder="输入贷款合同金额" value="${p2pDkjbxxDto.dkhtje}">
								</div>
						...
						<fieldset>
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-3">
							      	<c:if test="${p2pDkjbxxDto.status == 1}">
								    ...
								    <c:if test="${p2pDkjbxxDto.status == 2}">
						...
						<input type="hidden" id="hkys" name="hkys" value="${p2pDkjbxxDto.hkys}">
						<input type="hidden" id="syhkys" name="syhkys" value="${p2pDkjbxxDto.syhkys}">
						<input type="hidden" id="hkzt" name="hkzt" value="${p2pDkjbxxDto.hkzt}">
						<input type="hidden" name="orgCode" value="${p2pDkjbxxDto.orgCode}">
						<input type="hidden" name="id" value="${p2pDkjbxxDto.id}">
...
$().ready(function() {
	...
	$("#dkjbxxInfoForm").validate({
		...
		submitHandler:function(){
			...
			jQuery.ajax({
				type: "post",
			    url: "${pageContext.request.contextPath}/p2p/dkjbxx/doEdit",
...
//临时处理，后面不用这种方式
function loadSelect(){	
	var dklx = "${p2pDkjbxxDto.dklx}";
	var fsdd = "${p2pDkjbxxDto.fsdd}";
	var jcbz = "${p2pDkjbxxDto.jcbz}";
	var dbfs = "${p2pDkjbxxDto.dbfs}";
	var hkpl = "${p2pDkjbxxDto.hkpl}";
	var wjflzt = "${p2pDkjbxxDto.wjflzt}";
	var zhzt = "${p2pDkjbxxDto.zhzt}";
	var zhyyzxxts = "${p2pDkjbxxDto.zhyyzxxts}";
	var zjlx = "${p2pDkjbxxDto.zjlx}";
	var htbz = "${p2pDkjbxxDto.htbz}";
	var dkhtzt = "${p2pDkjbxxDto.dkhtzt}";
	var byhkzt = "${p2pDkjbxxDto.byhkzt}";
	
	$("#dklx_select").find("option[value="+dklx+"]").attr("selected",true);
	$("#fsdd_select").find("option[value="+fsdd+"]").attr("selected",true);
	$("#jcbz_select").find("option[value="+jcbz+"]").attr("selected",true);
	$("#dbfs_select").find("option[value="+dbfs+"]").attr("selected",true);
	$("#hkpl_select").find("option[value="+hkpl+"]").attr("selected",true);
	$("#wjflzt_select").find("option[value="+wjflzt+"]").attr("selected",true);
	$("#zhzt_select").find("option[value="+zhzt+"]").attr("selected",true);
	$("#zhyyzxxts_select").find("option[value="+zhyyzxxts+"]").attr("selected",true);
	$("#zjlx_select").find("option[value="+zjlx+"]").attr("selected",true);
	$("#htbz_select").find("option[value="+htbz+"]").attr("selected",true);
	$("#dkhtzt_select").find("option[value="+dkhtzt+"]").attr("selected",true);
	$("#byhkzt_select").find("option[value="+byhkzt+"]").attr("selected",true);
	chooseHkpl(hkpl);
}
