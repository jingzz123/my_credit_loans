...
/**
 * af_base_variable_expression
 * 
 * @author Ash
 * 
 */
public class BaseVariableExpressionDTO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5680150553215910517L;
	private int id;
