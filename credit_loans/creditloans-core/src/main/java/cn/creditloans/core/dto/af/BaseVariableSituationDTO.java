...
/**
 * af_base_variable_situation
 * 
 * @author Ash
 * 
 */
public class BaseVariableSituationDTO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -2862766598061703743L;
	private int id;
	private String name; // 名称
	private String description; // 描述
	private int type; // 变量类型
	private String attributeName; // 外部属性名
