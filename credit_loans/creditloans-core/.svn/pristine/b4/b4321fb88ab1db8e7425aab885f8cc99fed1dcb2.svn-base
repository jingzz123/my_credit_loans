 ...
 * 
 */
public class ValidatorElementDTO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -5750835523957401701L;
	private int id;
	...
	private String fileName;//暂时使用文件定义校验关系，后续再改
