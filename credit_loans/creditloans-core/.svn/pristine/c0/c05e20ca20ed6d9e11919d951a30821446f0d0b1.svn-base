...
public class EnterpriseDTO implements Serializable {
	...
	//旧菜单idList
	private List<Integer> oldMenuIdList = new ArrayList<Integer>();
	...
	public List<Integer> getOldMenuIdList() {
		return oldMenuIdList;
	}

	public void setOldMenuIdList(List<Integer> oldMenuIdList) {
		this.oldMenuIdList = oldMenuIdList;
	}
