...
public class Transaction implements Cloneable,Serializable,Comparable<Transaction>{
	...
	private static final long serialVersionUID = 565021630019169421L;
    ...
    /** output data using delimeter to separate column valuse instead of the transaction's delimiter or even the transaction hsa no delimiter
     * @return the data in the transaction using delimiter to separate column valuse
     * @param del delimiter to separate column values
     */
    ...
    public boolean setData(String data) {
        if(null == data)
            return false;
        if(m_schema.getType() == Schema.VARIOUS_LENGTH) {
            Tokenizer tokens = new Tokenizer(data, m_schema.getDelimeter(), false);
            ...
            for (int i = 0; i < m_columnNum; i++) {
                m_columnValues[i] = data.substring(pos, m_schema.getColumnPositions()[i]);
            ...
            for (int i = 0; i < m_columnNum; i++) {
                if(data[i] == null)
                    ...
                    if(types[i] != Schema.DATE && types[i] != Schema.TEXT)
                        m_columnValues[i] = Fmt.fmt(data[i], lengths[i], Fmt.ZF|Fmt.WN);
                    else
    ...
    /** Gets the value of the designated column  as a java.math.BigDecimal with full precision.
    ...
    ;
    /** Gets the value of the designated column  as a boolean in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column  as a byte in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a byte in the Java programming language.
     * @param columnName name of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a byte array in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a java.sql.Date object in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a double in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a float in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as an int in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a long in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a short in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    ...
    /** Gets the value of the designated column in the current row of this Record object as a String in the Java programming language.
     * @param columnIndex index of column
     * @return value of the column
     */
    public String getString(int columnIndex) {
        ...
        logger.error("m_columnValues:" + m_columnValues);
        logger.info("m_columnValues:" + m_columnValues);
        */
        if(m_columnValues[columnIndex]==null)
            return null;
    ...
    public String getString(String columnName) {
        ...
        logger.error("columnNames:" + m_schema.m_columnNames);
        logger.error("columnDesces:" + m_schema.m_columnDesces);
        */
        return  getString(i);
    }
     ...
     * @param columnIndex name of column
     * @param x value of the column
     */
    ...
    public void updateDouble(int columnIndex, double x) {
        int length = 0;
        // if(columnIndex > 0)
        //     length = m_schema.m_columnPositions[columnIndex] - m_schema.m_columnPositions[columnIndex-1];
        // else
    ...
    /**
     * @param ref schema of the Transaction
     */
    ...
    /*
     * get the combining String according to the column indexes;
     * it will not judge the correction of the parameters
    ...
    public int compareTo(Transaction tran){
        ...
        for (int i = 0; i < sortCount; i++)
        {
          ...
          if(sortNameType==Schema.NUMBER||
        		  sortNameType==Schema.INT||
        	  ...
        	  result = sortTypes[i] == ValidatorConstants.ASCEND ? d1.compareTo(d2) : d2.compareTo(d1);
          }else if(sortNameType==Schema.STRING||
        		  sortNameType==Schema.TEXT){
              String s1 = ValidatorConstants.select(getString(i));
              String s2 = ValidatorConstants.select(tran.getString(i));
              result = sortTypes[i] == ValidatorConstants.ASCEND ? s1.compareTo(s2) : s2.compareTo(s1);
          }else{
        	  //TODO：主要日期没有处理
        	  result = 0;
          }
    ...
    public String converToString() {
    	if(this.m_columnValues != null && this.m_columnValues.length > 0) {
    		StringBuilder builder = new StringBuilder();
    		for (String val : m_columnValues) {
    			builder.append(val);
    			builder.append("|");
			}
    		return builder.toString();
