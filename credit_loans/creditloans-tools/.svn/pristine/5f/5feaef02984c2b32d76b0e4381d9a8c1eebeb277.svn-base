...
public class Parser implements ParserTreeConstants, ParserConstants {
	...
	private Expression jep;

	public Node parseStream(java.io.Reader stream, Expression jep_in)
	...
	final public void Function() throws ParseException {
		...
		try {
			...
			if (jep.funTab.containsKey(identString)) {
				...
				reqArguments = ((PostfixMathCommandI) jep.funTab
						.get(identString)).getNumberOfParameters();
	...
	final public void ArgumentList(int reqArguments, String functionName)
			throws ParseException {
		int count = 0;
		String errorStr = "";
		if (jj_2_6(1)) {
	...
	@SuppressWarnings("unused")
	final public Vector<Object> Array() throws ParseException {
		Object value;
	...
	final private int[] jj_la1_0 = { 0x1, 0x100000, 0x80000, 0x48000, 0x48000,
			0x36000, 0x36000, 0x600000, 0x600000, 0x3800000, 0x4600000,
			0x8000000, 0x400, 0x800002a0, 0x10000000, 0x40000000, 0x800002a0,
			0x40000000, 0xa0, };
	...
	private void jj_add_error_token(int kind, int pos) {
		...
		if (pos == jj_endpos + 1) {
			...
			for (java.util.Enumeration<int[]> en = jj_expentries.elements(); en
					.hasMoreElements();) {
