...
public class NestSchema extends Schema{
	...
	private static final long serialVersionUID = 5381858614954123330L;
    ...
    public NestSchema() {
        //setType(NESTED);
        super();
        m_propertyMap.put(TranConstants.NESTED, TranConstants.NESTED_YES);
        m_propertyMap.put(TranConstants.ID_LENGTH, TranConstants.ID_DEFAULT_LENGTH);
    }
     ...
     */    
    public NestSchema(String[] columnNames, int[] columnTypes, int[] columnLengths){
